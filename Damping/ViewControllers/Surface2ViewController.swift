...
class Surface2ViewController: ViewController, NChartSeriesDataSource, NChartValueAxisDataSource {
        ...
        var result: [NChartPoint] = []
            ...
            for n in 0...Shared.instance.N - 1 {
                for m in 0...Shared.instance.M {
                    result.append(NChartPoint(state: NChartPointState(x: Double(n) * Shared.instance.tau, y: Shared.instance.solution[n][0][m], z: (Double(m) + 0.5) * Shared.instance.h_r), for: series))
                }
            }
